...
ModLoader.SetupFileHook("lua/TechData.lua", "lua/CNBalance/CombatEngineers_SoundPref.lua", "post")
-- Combat Engineers announcements rendered in the marine colour with no "(Team)" prefix. Hooked on
-- Chat.lua because it reaches that file's chatMessages upvalue.
ModLoader.SetupFileHook("lua/Chat.lua", "lua/CNBalance/CombatEngineers_Chat.lua", "post")
-- "Com Eng" tab in Options -> Mods. ModsMenuData.lua is the file vanilla explicitly invites mods to
-- post-hook to add their own options category.
ModLoader.SetupFileHook("lua/menu2/NavBar/Screens/Options/Mods/ModsMenuData.lua", "lua/CNBalance/CombatEngineers_ModsMenuData.lua", "post")

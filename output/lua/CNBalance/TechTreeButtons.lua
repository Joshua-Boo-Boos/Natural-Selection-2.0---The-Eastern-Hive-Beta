...
-- "Take Credits" build-menu entry. Borrows the resource-collection icon, which already reads as
-- "resources" - it is not a structure and has no artwork of its own.
kTechIdToMaterialOffset[kTechId.CombatEngineersCredits] = 137

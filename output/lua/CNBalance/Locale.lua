...
kTranslateMessage["COMBAT_INJECTOR"]="战斗注射器"
kTranslateMessage["STATUS_COMBAT_INJECTOR"]="战斗注射器"
kTranslateMessage["COMBAT_INJECTOR_TOOLTIP"]="战斗注射器增强前线士兵的战斗能力，用以对抗卡拉威胁。"
kTranslateMessage["COMBAT_INJECTOR_BUYDESCRIPTION"]="布雷泽工业战斗注射器。\n*四种模式：\n*再生/解毒剂/猫包/防御+\n     再生：每秒回复5点生命值，持续40秒\n     解毒剂：当前实体免受孢子伤害（如果是普通陆战队员，则无需购买JP/Exo）\n     猫包：10秒催化剂包\n*防御+：9秒纳米护盾"
...
kTranslateMessage["BUYMENU_GROUPLABEL_EQUIPMENT"]="装备"
...
kLocales["COMBAT_INJECTOR"]="Combat Injector"
kLocales["STATUS_COMBAT_INJECTOR"]="Combat Injector"
kLocales["COMBAT_INJECTOR_TOOLTIP"]="The Combat Injector enhances Frontiersmen forces for combat against the Kharaa threat."
kLocales["COMBAT_INJECTOR_BUYDESCRIPTION"]="Brazier Industries Combat Injector.\n*Four modes:\n*Regen/Antidote/Cat-Pack/Defense+\n     Regen: 5HP/s for 40s\n     Antidote: No spores damage for current entity (don't buy JP/Exo if normal marine)\n     Cat-Pack: 10s Catalyst Packs\n     Defense+: 9s Nanoshield"
...
kLocales["BUYMENU_GROUPLABEL_EQUIPMENT"]="Equipment"

...
function ParseMarineBuildMessage(t)
    return t.origin, t.direction, t.structureIndex, t.lastClickedPosition, t.lastClickedNormal
end

function OnCommandMarineBuildStructure(client, message)

    local player = client:GetControllingPlayer()
    local origin, direction, structureIndex, lastClickedPosition, lastClickedNormal = ParseMarineBuildMessage(message)
    ...
    if dropStructureAbility and dropStructureAbility.OnDropStructure then
        dropStructureAbility:OnDropStructure(origin, direction, structureIndex, lastClickedPosition, lastClickedNormal)
    end
